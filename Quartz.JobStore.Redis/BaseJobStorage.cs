...
namespace QuartzRedisJobStore.JobStore
{
    ...
    public abstract class BaseJobStorage
    {
        ...
        public abstract Task<List<string>> PauseJobsAsync(GroupMatcher<JobKey> matcher);
        ...
        /// </para>
        /// </summary>
        public abstract Task<List<string>> ResumeJobsAsync(GroupMatcher<JobKey> matcher);
        ...
        /// </para>
        /// </summary>
        public abstract Task<List<string>> ResumeTriggersAsync(GroupMatcher<TriggerKey> matcher);
        ...
        public async Task<List<IOperableTrigger>> AcquireNextTriggersAsync(DateTimeOffset noLaterThan, int maxCount, TimeSpan timeWindow)
        {
        ...
        ///             could be fired.
        /// </returns>
        public abstract Task<List<TriggerFiredResult>> TriggersFiredAsync(IReadOnlyCollection<IOperableTrigger> triggers);
        ...
        public async Task<ICalendar> RetrieveCalendarAsync(string calName)
        {
            ...
            if (calendarPropertiesInRedis != null && calendarPropertiesInRedis.Any()) 
            {
                ...
                calendar = JsonSerializer.Deserialize<ICalendar>(calendarProperties[RedisJobStoreSchema.CalendarSerialized], new JsonSerializerOptions{ PropertyNamingPolicy = JsonNamingPolicy.CamelCase });
            }
        ...
        /// </remarks>
        public async Task<List<IOperableTrigger>> GetTriggersForJobAsync(JobKey jobKey)
        {
        ...
        /// </summary>
        /// <returns/>
        public async Task<List<string>> GetPausedTriggerGroupsAsync()
        {
        ...
        /// <param name="matcher"/>
        /// <returns/>
        public abstract Task<List<JobKey>> JobKeysAsync(GroupMatcher<JobKey> matcher);
        ...
        /// </para>
        /// </summary>
        public abstract Task<List<TriggerKey>> TriggerKeysAsync(GroupMatcher<TriggerKey> matcher);
        ...
        /// </para>
        /// </summary>
        public async Task<List<string>> JobGroupNamesAsync()
        {
        ...
        /// </para>
        /// </summary>
        public async Task<List<string>> TriggerGroupNamesAsync()
        {
        ...
        /// </para>
        /// </summary>
        public async Task<List<string>> CalendarNamesAsync()
        {
        ...
        ///             paused.
        /// </remarks>
        public abstract Task<List<string>> PauseTriggersAsync(GroupMatcher<TriggerKey> matcher);
        ...
        protected HashEntry[] ConvertToHashEntries(ICalendar calendar)
        {
            var entries = new List<HashEntry>
                {
                    new HashEntry(RedisJobStoreSchema.CalendarSerialized, JsonSerializer.Serialize(calendar, new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase }))
                };
