...
namespace QuartzRedisJobStore.JobStore
{
    ...
    public class RedisStorage : BaseJobStorage
    {
        ...
        /// </summary>
        public override async Task<List<string>> PauseJobsAsync(GroupMatcher<JobKey> matcher)
        {
        ...
        /// </para>
        /// </summary>
        public override async Task<List<string>> ResumeJobsAsync(GroupMatcher<JobKey> matcher)
        {
        ...
        /// </para>
        /// </summary>
        public override async Task<List<string>> ResumeTriggersAsync(GroupMatcher<TriggerKey> matcher)
        {
        ...
        ///             could be fired.
        /// </returns>
        public override async Task<List<TriggerFiredResult>> TriggersFiredAsync(IReadOnlyCollection<IOperableTrigger> triggers)
        {
        ...
        /// <param name="matcher"/>
        /// <returns/>
        public override async Task<List<JobKey>> JobKeysAsync(GroupMatcher<JobKey> matcher)
        {
        ...
        /// </para>
        /// </summary>
        public override async Task<List<TriggerKey>> TriggerKeysAsync(GroupMatcher<TriggerKey> matcher)
        {
        ...
        ///             paused.
        /// </remarks>
        public override async Task<List<string>> PauseTriggersAsync(GroupMatcher<TriggerKey> matcher)
        {
